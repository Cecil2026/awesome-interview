(function () {
  ...
  const translations = {
    ...
    zh: {
      ...
      chooseMarkdownDescription: '通过左侧面板浏览项目里的 Markdown 模块。阅读器会把 Markdown 渲染成清爽的页面，让你专注内容本身，无需关心原始格式。',
      ...
      themeLight: '浅色',
      themeDark: '深色',
      translationFallback: '该文件暂无中文翻译，下方显示英文原文。',
  ...
  const fileLabels = {
    ...
    'knowledge/big-data.md': { en: 'Big Data', zh: '大数据' },
    'knowledge/devops.md': { en: 'DevOps', zh: 'DevOps' },
    'knowledge/distributed.md': { en: 'Distributed Systems', zh: '分布式' },
